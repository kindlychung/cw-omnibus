...
public class HeaderDetailListDemo extends ListActivity {
    ...
    private static final int n0 = items[0].length;
    private static final int n1 = items[1].length + n0;
    private static final int n2 = items[2].length + n1;
    private static final int n3 = items[3].length + n2;
    private static final int n4 = items[4].length + n3;
    ...
    class IconicAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            TextView sizeBlock = row.findViewById(R.id.size);
            ...
            label.setText(word);
            sizeBlock.setText(String.format(getString(R.string.size_template),
                    word.length()));
